...
DECLARE_INSTANCE_CHECKER(StellarisADCState, STELLARIS_ADC, TYPE_TM4_ADC)
...
static stellaris_board_info stellaris_boards[] = {
  { "LM3S811EVB",
    0,          // vers: 0, class: 0, major: 0, minor: 0
    0x0032000e, // vers: 0, fam: 0, partno: 50, pincount: 0, temp: 0, pkg: 1, rohs: 1, qual: 2
    0x001f001f, /* dc0 */
    0x001132bf,
    0x01071013,
    0x3f0f01ff,
...
static void stellaris_init(MachineState *ms, stellaris_board_info *board)
{
    ...
    if (board->dc1 & (1 << 16)) {
        dev = sysbus_create_varargs(TYPE_TM4_ADC, 0x40038000,
    ...
    if (board->peripherals & BP_GAMEPAD) {
        ...
        gpad = qdev_new(TYPE_TM4_GAMEPAD);
